        ...
        public static void GeneratedArray()
        {
            ...
            try
            {
                ...
                double[ , , , ] myArray2 = new double[3, 4, 2, 3]
               {
                ...
                Console.WriteLine( " the value of GetLength (0) is {0}", myArray.GetLength(0));
                Console.WriteLine(" the value of GetLength (1) is {0}", myArray.GetLength(1));
                Console.WriteLine(" the value of GetLength (2) is {0}", myArray.GetLength(2));
                Console.WriteLine(" the value of GetLength (3) is {0}", myArray.GetLength(3));
                Console.WriteLine(" the value of GetLength (0)-1  is {0}", myArray2.GetLength(1) - 1);
                Console.ReadLine();
